...
describe('Router', () => {
  ...
  describe('constructor', () => {
    ...
    it('should create a nested router with parent, domain and config', () => {
      ...
      const childRouter = new Router(parentRouter, 'products', { schema: mockSchema })
  ...
  describe('create method', () => {
    it('should register create handler', () => {
      ...
      const handler = vi.fn().mockResolvedValue({ id: '1', name: 'John', email: 'john@example.com' })
  ...
  describe('update method', () => {
    it('should register update handler', () => {
      ...
      const handler = vi.fn().mockResolvedValue({ id: '1', name: 'John Updated', email: 'john@example.com' })
  ...
  describe('method chaining', () => {
    it('should support method chaining', () => {
      ...
      const createHandler = vi.fn().mockResolvedValue({ id: '1', name: 'John', email: 'john@example.com' })
      const readHandler = vi.fn().mockResolvedValue({ id: '1', name: 'John', email: 'john@example.com' })
      const updateHandler = vi.fn().mockResolvedValue({ id: '1', name: 'John Updated', email: 'john@example.com' })
