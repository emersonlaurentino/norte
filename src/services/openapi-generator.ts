...
export class OpenAPIGenerator {
  ...
  public hasCustomServers(): boolean {
    return !!this.#openapiOptions?.servers
  }

  public generateDocument(req?: Request): Record<string, unknown> {
    const useCache = !req && this.#cachedDocument

    if (useCache) {
      return this.#cachedDocument as Record<string, unknown>
    }
    ...
    let servers = this.#openapiOptions?.servers
    if (!servers && req) {
